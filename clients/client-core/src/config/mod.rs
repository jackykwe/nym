...
impl Default for DebugConfig {
    fn default() -> Self {
        DebugConfig {
            average_packet_delay: autogenerated::THOUSAND_OVER_MU,
            average_ack_delay: autogenerated::THOUSAND_OVER_MU_ACK,
            ack_wait_multiplier: DEFAULT_ACK_WAIT_MULTIPLIER,
            ack_wait_addition: DEFAULT_ACK_WAIT_ADDITION,
            loop_cover_traffic_average_delay: autogenerated::THOUSAND_OVER_LAMBDA_L,
            message_sending_average_delay: autogenerated::THOUSAND_OVER_LAMBDA_P,
